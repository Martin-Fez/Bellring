...
//public class EnemyThreeLogic : MonoBehaviour
public class EnemyThreeLogic : IEnemyLogic
{
    ...
    public override IEnemyStateBoxer returnNextState()
    {
        ...
        if (enemyBoxer.enemyHealth < (enemyBoxer.enemyMaxHealth / 2))
        {
            enemyBoxer.MaxstateCooldown = 2;
        }
        else
            enemyBoxer.MaxstateCooldown = 4;
